...
export default function AnnouncementDetailPage({ params: paramsPromise }) {
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="flex flex-wrap items-center gap-4 mb-6">
                <span
                  className={`text-sm font-bold uppercase tracking-widest px-4 py-1.5 rounded-full text-white ${announcement.badgeColor}`}
                >
                  {announcement.badge}
                </span>
